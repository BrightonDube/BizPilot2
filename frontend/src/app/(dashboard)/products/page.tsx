  ...
  return (
    ...
    >
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className={`font-medium ${product.is_low_stock ? 'text-red-400' : 'text-gray-100'}`}>
                    {product.quantity} {product.is_low_stock && '(Low)'}
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  ...
                  >
                    ...
                    <td className="p-4">
                      <span className={product.is_low_stock ? 'text-red-400' : 'text-gray-400'}>
                        {product.quantity}
                        {product.is_low_stock && <span className="ml-2 text-xs">(Low)</span>}
                      </span>
                    </td>
      ...
      {products.length > 0 && (
        ...
        >
          <h3 className="font-semibold text-gray-100 mb-4">Catalog Summary</h3>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            {[
              { label: 'Total Products', value: total },
              { 
                label: 'Avg. Price', 
                value: formatCurrency(products.reduce((sum, p) => sum + p.selling_price, 0) / products.length)
              },
              { 
