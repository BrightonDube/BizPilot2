      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <Card className="bg-gray-800/50 border-gray-700 hover:border-blue-500/50 transition-colors">
                <CardContent className="flex items-center justify-between p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium text-white">Sales Reports</p>
                      <p className="text-xs text-gray-400">Daily, weekly, monthly analysis</p>
                    </div>
                  </div>
            ...
            <Link href="/reports/inventory" className="group">
              <Card className="bg-gray-800/50 border-gray-700 hover:border-green-500/50 transition-colors">
                <CardContent className="flex items-center justify-between p-4">
                  <div className="flex items-center gap-3">
                    <Package className="w-5 h-5 text-green-400" />
                    <div>
                      <p className="font-medium text-white">Inventory Reports</p>
                      <p className="text-xs text-gray-400">Stock levels, movements, valuation</p>
                    </div>
                  </div>
            ...
            <Link href="/reports/staff" className="group">
              <Card className="bg-gray-800/50 border-gray-700 hover:border-purple-500/50 transition-colors">
                <CardContent className="flex items-center justify-between p-4">
                  <div className="flex items-center gap-3">
                    <ClipboardList className="w-5 h-5 text-purple-400" />
                    <div>
                      <p className="font-medium text-white">Staff Reports</p>
                      <p className="text-xs text-gray-400">Performance, attendance, productivity</p>
                    </div>
                  </div>
