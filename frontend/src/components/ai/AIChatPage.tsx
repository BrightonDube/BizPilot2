...
export function AIChatPage() {
  ...
  return (
    <motion.div
      className="flex flex-col gap-6 resize-y overflow-auto"
    ...
    >
      <div className="flex-1 flex flex-col min-h-0">
        <div className="mb-4">
          ...
          <p className="text-gray-400">Ask about your business, sales, inventory, or get help with BizPilot.</p>
                ...
                >
                  ...
                  <div
                    className={`max-w-[70%] rounded-2xl px-4 py-3 ${
                      m.role === 'user' ? 'bg-blue-600 text-white' : 'bg-gray-900/50 border border-gray-700 text-gray-100'
                    }`}
                  >
