...
- ✅ **bizpilot-api** (Backend API)
- ✅ **bizpilot-web** (Frontend)
- ✅ **bizpilot-db** (PostgreSQL Database)
...
1. Go to **bizpilot-api** service → **Environment**
...
1. Go to **bizpilot-web** service → **Environment**
...
- ✅ Test backend health: `https://bizpilot-api.onrender.com/health`
...
- ✅ Ensure both backend and frontend have same credentials
...
- ✅ Enable **IP Allowlist** on database for production
- ✅ Use **Starter** or higher plan for always-on production apps
- ✅ Regularly rotate SECRET_KEY and NEXTAUTH_SECRET
