...
Revision ID: 4c77b07b9fef
Revises: ef79f6d52049
...
down_revision: Union[str, None] = 'ef79f6d52049'
...
def upgrade() -> None:
    ...
    if not _table_exists("floor_plan_tables"):
        op.create_table(
            "floor_plan_tables",
    ...
    if not _table_exists("floor_plan_section_assignments"):
        op.create_table(
