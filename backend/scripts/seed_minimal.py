"""
Minimal Production Seed Script for BizPilot

This script seeds ONLY the essential data needed for login:
- Subscription tiers
- Demo user
- Superadmin user

Run: python -m scripts.seed_minimal
"""
...
def main():
    ...
    print("\n" + "=" * 60)
    print("BizPilot Minimal Seed Script")
    print("=" * 60 + "\n")
