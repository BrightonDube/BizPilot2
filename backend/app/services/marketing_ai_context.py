...
class MarketingAIValidator:
    ...
    def is_marketing_question(question: str) -> bool:
        ...
        business_specific_terms = [
            ...
            'my analytics', 'customer analytics', 'sales analytics',
            'my performance', 'my metrics', 'my statistics'
        ]
        
        question_lower = question.lower()
        
        # Reject if contains business-specific terms
        if any(term.lower() in question_lower for term in business_specific_terms):
            return False
