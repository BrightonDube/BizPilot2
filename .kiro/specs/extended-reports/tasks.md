...
- [x] 1.1 Create UserActivityReport and UserActivityItem schemas in `backend/app/schemas/report.py`
- [x] 1.2 Implement `get_user_activity_report()` endpoint in `backend/app/api/reports.py`
- [x] 1.3 Add business isolation and date range filtering
- [x] 1.4 Calculate total hours, break duration, and active sessions
- [ ] 1.5 Write unit tests for user activity endpoint

### Task 2: Login History Report API
- [x] 2.1 Create LoginHistoryReport and LoginHistoryItem schemas in `backend/app/schemas/report.py`
- [x] 2.2 Implement `get_login_history_report()` endpoint in `backend/app/api/reports.py`
- [x] 2.3 Add suspicious activity detection logic
- [x] 2.4 Calculate session durations
- [ ] 2.5 Write unit tests for login history endpoint

### Task 3: Excel Export Functionality
- [x] 3.1 Add openpyxl dependency to `requirements.txt`
- [x] 3.2 Create Excel export utility in `backend/app/core/excel.py` only if it does not exist yet
- [x] 3.3 Implement `export_excel()` endpoint in `backend/app/api/reports.py`
- [x] 3.4 Add support for all report types
